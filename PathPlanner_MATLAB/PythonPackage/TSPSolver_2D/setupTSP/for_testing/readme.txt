setupTSP MATLAB Python Package
...
2. Installing the setupTSP Package

A. Change to the directory that contains the file setup.py and the subdirectory setupTSP. 
...
3. Using the setupTSP Package

The setupTSP package is on your Python path. To import it into a Python script or 
session, execute:
