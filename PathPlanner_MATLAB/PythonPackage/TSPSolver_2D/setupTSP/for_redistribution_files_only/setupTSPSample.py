#!/usr/bin/env python
"""
Sample script that uses the setupTSP module created using
MATLAB Compiler SDK.
...
my_setupTSP = setupTSP.initialize()

start_posIn = matlab.double([53.95375719839131, -1.0404824359104623, 50.0], size=(1, 3))
goal_posIn = matlab.double([53.94537235295549, -1.0177802188084115, 50.0], size=(1, 3))
...
altitude_limitsIn = {"min": matlab.double([20.0], size=(1, 1)), "max": matlab.double([100.0], size=(1, 1))}
...
coordinate_pathOut, dubins_path_waypointsOut = my_setupTSP.setupTSP(start_posIn, goal_posIn, polygon_verticesIn, wind_directionIn, altitude_limitsIn, uav_turning_radiusIn, num_divisionsIn, plot_resultsIn, nargout=2)
print(coordinate_pathOut, dubins_path_waypointsOut, sep='\n')

sleep(100)

my_setupTSP.terminate()
