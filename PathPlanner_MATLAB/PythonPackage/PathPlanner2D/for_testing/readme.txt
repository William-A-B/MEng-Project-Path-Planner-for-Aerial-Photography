PathPlanner2D MATLAB Python Package
...
2. Installing the PathPlanner2D Package

A. Change to the directory that contains the file setup.py and the subdirectory 
PathPlanner2D. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the PathPlanner2D Package

The PathPlanner2D package is on your Python path. To import it into a Python script or 
session, execute:
