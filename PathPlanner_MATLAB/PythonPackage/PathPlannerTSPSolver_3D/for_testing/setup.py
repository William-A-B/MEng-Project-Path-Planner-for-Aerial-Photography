...
if __name__ == '__main__':
    setup_dict = {
        'name': 'PathPlannerTSPSolver_3D-R2024b',
        'version': '24.2',
        'description': 'A Python interface to PathPlannerTSPSolver_3D',
        'author': 'MathWorks',
        'url': 'https://www.mathworks.com/',
        'platforms': ['Linux', 'Windows', 'macOS'],
        'packages': [
            'PathPlannerTSPSolver_3D'
        ],
        'package_data': {'PathPlannerTSPSolver_3D': ['*.ctf']}
    }
