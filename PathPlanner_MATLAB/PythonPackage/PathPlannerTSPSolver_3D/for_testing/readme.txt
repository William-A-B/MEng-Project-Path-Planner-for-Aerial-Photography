PathPlannerTSPSolver_3D MATLAB Python Package
...
2. Installing the PathPlannerTSPSolver_3D Package

A. Change to the directory that contains the file setup.py and the subdirectory 
PathPlannerTSPSolver_3D. If you do not have write permissions, copy all its contents to a 
...
3. Using the PathPlannerTSPSolver_3D Package

The PathPlannerTSPSolver_3D package is on your Python path. To import it into a Python 
